# How to distribute Giffy within your own Department/Agency/Region/Division/Branch/Section

#### Step 1: Clone the source

Create a Github clone of Giffy using [our tutorial](Compilation.md).
